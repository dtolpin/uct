...
\draw (root) -- ++(1.5,1.0) -- ++(1.5, 0)
	node (a1) [arm,label=right:{$\mu_1=0.6$}] {$arm_1$};

\draw [seledge] (root) -- ++(1.5,0.2) -- ++(1.5, 0)
	node (a2) [arm,selnode,label=right:{$\mu_2=0.9=\mu_*$}] {$arm_2$};

\draw [dashed] (root) -- ++(1.5, -0.4) -- ++(1.5, 0);

\draw (root) -- ++(1.5,-1.0) -- ++(1.5, 0)
	node (a3) [arm,label=right:{$\mu_K=...$}] {$arm_K$};
