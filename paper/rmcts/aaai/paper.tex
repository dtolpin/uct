...
\section{Monte Carlo Search for Simple Regret Minimization}
\label{sec:results}
...
step onwards. 
\end{itemize}
Here, we introduce simple schemes more amenable to analysis, and compare
