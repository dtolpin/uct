...
on the Chernoff-Hoeffding bound:
\begin{equation}
...
\end{eqnarray}
and find conditional minima of $P_j(\delta_j, \epsilon)$ by requiring
either $\frac {\partial P_j} {\partial \delta_j}=0$ or ${\partial P_j}
{\partial \varepsilon}=0$. 

$\frac {\partial P_j} {\partial \delta_j}=0$:
...
corresponds to uniform random sampling, the tightest bound is obtained
by splitting the interval at the middle and the convergence rate
is $exp\left(-\frac {\Delta_j^2n} {2K}\right)$.
